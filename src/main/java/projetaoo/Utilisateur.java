...
public class Utilisateur {
    ...
    private HashMap<MoyenTransport, Integer> minutesMoyenTransport; // par mois, il faut qu'on sauvegarde les données dès le
                                                            // début
    private HashMap<Month, Float> quantiteDechets; // en kilos, par mois, le compteur va se reinitialiser au début de chaque
                                           // mois
    ...
    public HashMap<MoyenTransport, Integer> getMinutesMoyenTransport() {
        return minutesMoyenTransport;
    }

    public void initMinutesTransport (MoyenTransport moyen) {
        this.minutesMoyenTransport.put(moyen, Integer.valueOf(0));
    }

    public void addConsoEau(MoyenTransport moyen, Integer nbMinutes) {
